...
export const routesConfiguration =  [
  ...
  { path: "/context1", element: <Demo2AContext />, label: 'Context A' },
  { path: "/context2", element: <Demo2BContext />, label: 'Context B' },
  { path: "/context3", element: <Demo2CContext />, label: 'Context C' },
  { path: "/context4", element: <Demo2DContext />, label: 'Context D' },
  ...
  { path: "/zustand3", element: <ZustandDemo3 />, label: 'Zustand: Demo C' },
  { path: "/zustand4", element: <ZustandDemo4 />, label: 'Zustand: Demo D' },
  { path: "/zustand5", element: <ZustandDemo5 />, label: 'Zustand: Demo E' },
  ...
  { path: "/jotai5", element: <JotaiDemo5 />, label: 'Jotai 5: splitAtom' },
  { path: "/jotai6", element: <JotaiDemo6 />, label: 'Jotai 6:  atomWithStorage' },
